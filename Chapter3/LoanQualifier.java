...
//This program demostrate a nested if statement
...
public class LoanQualifier 
{
    public static void main(String[] args)
    {
        ...
        System.out.print("Enter your annaual salary: ");
        salary = keyboard.nextDouble();
        
        //Get the numbe rof years at the current job. 
        System.out.print("Enter the number of years " + 
                         "at current job: ");
        yearsOnJob = keyboard.nextDouble();
        
        //Determine wheather the user qualifies for the loan.
        if (salary >= 50000)
        {
            if (yearsOnJob >=2)
            {
